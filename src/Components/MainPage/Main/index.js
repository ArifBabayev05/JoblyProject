  ...
  return (
    <div className='container'>
        ...
        <div className='col-lg-6 h2'>
            <h2 className=''>Yeni <span>Karyera <br/> İmkanları </span><br/> Əldə Edin!</h2>
            <p>Biliklərinizi təsdiq edin, sertifikat alın və axtardığınız işi asanlıqla tapın!</p>

            <form className='homepage_search'>
                <input type='hidden' />
                <label for='search'></label>
                <input className='search' placeholder='İş adı və ya açar söz'/>
